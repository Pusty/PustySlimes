...
public class SlimeBookItem2 extends Item{


	public SlimeBookItem2(int par1) {
		super(par1);
    ...
    public void registerIcons(IconRegister iconRegister) {
        ...
        this.itemIcon = iconRegister.registerIcon("pustyslime:" + "slimebook2");
    ...
    player.openGui(PustySlime.instance, 6, world, 0, 0, 0);
    	}
    	return itemstack;
    }
...
l.add("specified on Basic Slimes");
