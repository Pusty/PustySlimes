...
public class SlimeMutatorItem extends ItemBlock
{
...
{
         return PustySlime.mutatorBlock.getBlockTextureFromSide(par1);
...
{
	 return EnumChatFormatting.BLUE+"SlimeMutator"; 
}
...
l.add(EnumChatFormatting.GRAY+"for the Mutation of Slimes");
}
