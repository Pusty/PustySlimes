...
public class SlimeObjectItem extends ItemBlock
{
public SlimeObjectItem(int par1)
{
         super(par1);
         this.setMaxDamage(0);
...
{
         return PustySlime.objectBlock.getBlockTextureFromSide(par1);
...
{
	 return EnumChatFormatting.BLUE+"SlimeBox"; 
}
...
l.add(EnumChatFormatting.GRAY+"for storing Slimes");
}
