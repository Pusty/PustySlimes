...
{
    private TileEntityGenerator furnace;
    private int itemdamage = 0;

    public GeneratorContainer(InventoryPlayer par1InventoryPlayer, TileEntityGenerator te)
    {
        this.furnace = te;
        this.addSlotToContainer(new SlotGenerator(te, 0, 81, 41));
        int i;
