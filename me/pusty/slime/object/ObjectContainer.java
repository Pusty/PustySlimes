...
{
    private TileEntityObject furnace;
    private int itemdamage = 0;

    public ObjectContainer(InventoryPlayer par1InventoryPlayer, TileEntityObject te)
    {
        this.furnace = te;
        this.addSlotToContainer(new SlotObject(te, 0, 81, 41));
        int i;
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            */
            ...
            else if (par2 != 0)
            {
                ...
                else if (par2 >= 30 && par2 < 37 && !this.mergeItemStack(itemstack1, 3, 30, false))
                {
                    return null;
                }
            }
