...
public class PustyObjectBlock extends BlockContainer
{
        ...
        int id;
        public PustyObjectBlock(int i,Class tClass)
                {
...
return false;
   	...
   	public boolean onBlockActivated(World world, int x, int y, int z, EntityPlayer p, int par6, float par7, float par8, float par9) {
           if (world.isRemote)
           {
   	   TileEntityObject te = ((TileEntityObject)world.getBlockTileEntity(x, y, z));
           ...
           else
           {
               ...
               if (te != null)
               {
               	...
               	p.openGui(PustySlime.instance, 2, world, te.xCoord, te.yCoord, te.zCoord);
           	   }
               }
       ...
       {
    	   TileEntityObject dummy = (TileEntityObject)world.getBlockTileEntity(x, y, z);
	...
	public TileEntity createNewTileEntity(World var1) {
		TileEntityObject p =	new TileEntityObject();
