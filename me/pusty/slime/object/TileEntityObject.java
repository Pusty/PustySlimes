...
public class TileEntityObject  extends TileEntity  implements IInventory{

	public TileEntityObject(){
	   ...
	   public boolean isOpen = false;
	    ...
	    {
	        return this.isInvNameLocalized() ? this.customName : "SlimeObject";
	    }
