...
public class SlimeObjectRender extends TileEntitySpecialRenderer
{ 
    private PustyObjectModel aModel;
    private PustySlimeModel bModel;

    public SlimeObjectRender()
    {
        aModel = new PustyObjectModel();
        bModel  = new PustySlimeModel();
    }
       
    public void renderAModelAt(TileEntityObject tileentity1, double d, double d1, double d2, float f)
    {  
        ...
        GL11.glTranslatef((float)d + 0.5F, (float)d1-0.5F, (float)d2 + 0.5F);
		  ...
		  Minecraft.getMinecraft().renderEngine.func_110577_a(new ResourceLocation("PustySlime:textures/slime/pustyobject.png"));
        	
        GL11.glPushMatrix();
        aModel.renderModel(0.0625F,tileentity1.isOpen);
   //     GL11.glPopMatrix();    
	...
	public void renderTileEntityAt(TileEntity var1, double var2, double var4,
        ...
        renderAModelAt((TileEntityObject)var1, var2, var4, var6, var8);
